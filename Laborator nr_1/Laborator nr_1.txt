...
if y<=0:
    print("Ошибка: количество лет не может быть отрицательным или нулевым числом")'''
...
if (S<0) and (K<0) and (X<0):
    print("Ошибка: сумма на счету не может быть отрицательным числом")'''
